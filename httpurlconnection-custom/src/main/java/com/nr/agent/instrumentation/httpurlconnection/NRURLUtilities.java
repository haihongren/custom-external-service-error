...
public class NRURLUtilities {
	...
	public static void reportConnectionMetrics(URI requestURI, int responseCode, String httpMethod) {
...
//    	}
		AgentBridge.getAgent().getLogger().log(Level.FINE, "httpurlconnection responseCode: {0} ",responseCode);
		if(responseCode >= 500) {
